...
export function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center px-4 py-20 md:py-32 ">
      <div className="mb-6">
        <button className="bg-black text-white text-xs font-medium px-3 py-1 rounded-full flex items-center gap-2 hover:opacity-90 transition-opacity">
          <span className="bg-blue-500 text-white px-2 py-0.5 rounded-full text-[10px] font-bold">NEW</span>
          Introducing Security Swarm
        </button>
      </div>
      <h1 className="text-5xl md:text-7xl font-bold text-center mb-8 text-ink leading-tight">
        Devin, the AI<br />software engineer
      </h1>
      ...
      <div className="w-full max-w-[90%] mx-auto">
        <Image
          src="/hero-image.png"
          alt="Devin AI software engineer interface"
          width={1200}
          height={800}
