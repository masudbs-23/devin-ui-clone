      ...
      <div className="max-w-[90%] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
          ...
          <div className="flex-1">
            <h2 id="build-more-heading" className="text-5xl md:text-6xl font-bold text-ink leading-tight">
              Build more with<br />
          ...
          <div className="flex-1">
            <article className="bg-[#E3E2E1] p-8 rounded-2xl shadow-md w-[619px] h-[278px]">
        ...
        {/* Footer links */}
        <footer className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
          {/* Left section */}
          <nav className="flex-1 flex gap-[10px]" aria-label="Legal links">
            <a href="/privacy" className="text-ink hover:text-ink text-md">Privacy policy</a>
            <a href="/terms" className="text-ink hover:text-ink text-md">Terms of service</a>
            <a href="/privacy-choices" className="text-ink hover:text-ink text-md">Your privacy choices</a>
          </nav>
          {/* Right section */}
          <nav className="flex-1" aria-label="Social links">
